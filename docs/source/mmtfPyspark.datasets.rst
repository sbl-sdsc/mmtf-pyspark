...
.. toctree::
   ...
   mmtfPyspark.datasets.secondaryStructureExtractor
   mmtfPyspark.datasets.secondaryStructureSegmentExtractor
   mmtfPyspark.datasets.swissModelDataset
   mmtfPyspark.datasets.uniProt
